...
bot.command("start", async (ctx: typeof Context) => {
...
bot.on("message:successful_payment", async (ctx: typeof Context) => {
  console.log(
...
bot.on("pre_checkout_query", async (ctx: typeof Context) => {
