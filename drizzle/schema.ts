import { pgTable, bigint, varchar, boolean, foreignKey, serial, integer, timestamp, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const regularityEnum = pgEnum("regularity_enum", ['everyday', 'fewTimesAWeek'])
